...
extern "C" {
	 ...
	 */
	extern "C" Fvad *fvad_new();

	/*
	 * Frees the dynamic memory of a specified VAD instance.
	 */
	extern "C"  void fvad_free(Fvad *inst);
	 ...
	 */
	extern "C"  void fvad_reset(Fvad *inst);
	 ...
	 */
	extern "C"  int fvad_set_mode(Fvad* inst, int mode);
	 ...
	 */
	extern "C"  int fvad_set_sample_rate(Fvad* inst, int sample_rate);
	 ...
	 */
	extern "C"  int fvad_process(Fvad* inst, const int16_t* frame, size_t length);
